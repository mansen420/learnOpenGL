...
int main()
{
    ...
    unsigned int vao0id, vbo0id, ebo0id;
    VAO vao0(vao0id, vbo0id, ebo0id);
    vao0.bind();
    vao0.bindVBO(), vao0.bindEBO();
    vao0.vertexBufferData(vertices, GL_STATIC_DRAW), vao0.elementBufferData(indices, GL_STATIC_DRAW);
